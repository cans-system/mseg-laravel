<x-layout title="{{ $mansion->title }}">
  ...
  <section class="mansion-info">
    ...
    <div class="mansion-detail">
      <dl>
        ...
        <div class="detail-row">
          <dt><span>総戸数</span></dt>
          <dd class="half">{{ $mansion->total_units ? $mansion->total_units.'戸' : "ーーー" }}</dd>
          <dt><span>築年数</span></dt>
          <dd class="half">
        ...
        <div class="detail-row">
          <dt><span>階数</span></dt>
          <dd class="half">{{ $mansion->floors ?? "ーーー" }}</dd>
          <dt><span>建築構造</span></dt>
          <dd class="half">{{ $mansion->architecture ?? "ーーー" }}</dd>
        </div>
        <div class="detail-row">
          <dt><span>備考</span></dt>
          <dd><p>{{ $mansion->note ?? "ーーー" }}</p></dd>
        </div>
      </dl>
    </div>
  ...
  <section class="mansion-policy">
    ...
    <div class="flexbox">
      <div>
        <h4>一般的な査定価格</h4>
        <img src="{{ asset('img/Group 273.png') }}" alt="">
      </div>
      <div>
        <h4 class="our">弊社の特別査定価格</h4>
        <img src="{{ asset('img/Group 274.png') }}" alt="">
      </div>
    </div>
  </section>
  ...
  <section class="mansion-flow">
    ...
    <div class="flow-wrapper">
      <ul class="flex-list">
        <li class="flex-item">
          <div class="flow-icon">
            <img src="{{ asset('img/steps/Rectangle 93.png') }}" alt="">
          </div>
        ...
        <li class="flex-item">
          <div class="flow-icon">
            <img src="{{ asset('img/steps/Rectangle 94.png') }}" alt="">
          </div>
          <div class="flow-content">
        ...
        <li class="flex-item">
          <div class="flow-icon">
            <img src="{{ asset('img/steps/Rectangle 95.png') }}" alt="">
          </div>
          <div class="flow-content">
        ...
        <li class="flex-item">
          <div class="flow-icon">
            <img src="{{ asset('img/steps/Rectangle 96.png') }}" alt="">
          </div>
          <div class="flow-content">
        ...
        <li class="flex-item">
          <div class="flow-icon">
            <img src="{{ asset('img/steps/Rectangle 97.png') }}" alt="">
          </div>
          <div class="flow-content">
        ...
        <li class="flex-item">
          <div class="flow-icon">
            <img src="{{ asset('img/steps/Rectangle 98.png') }}" alt="">
          </div>
          <div class="flow-content">
